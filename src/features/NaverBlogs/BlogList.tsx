...
const BlogList = ({item}: BlogListProps) => {
    ...
    return (
        <li className="mt-3.5 text-xs c_sm:text-sm text-gray-400 hover:text-black w-full dark:text-gray-400 dark:hover:text-white font-semibold c_md:font-sans hover:font-semibold">
