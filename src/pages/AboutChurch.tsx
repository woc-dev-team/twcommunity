        ...
        <main className="p-8 c_md:p-20 text-start transition-all duration-500 ease-in-out">
            ...
            <div className="relative p-2">
                <button className="text-black dark:text-white hover:bg-gray-200 dark:hover:bg-gray-500 rounded-lg group text-sm c_md:text-lg">
                    에베소서 2 : 20
                    <div className="text-ms c_md:text-xl absolute left-1/2 transform -translate-x-1/2 opacity-0 group-hover:opacity-100 bg-black text-white dark:bg-white dark:text-black font-bold text-sm py-1 px-3 rounded-lg transition-all duration-300 ease-in-out top-full mt-2">
