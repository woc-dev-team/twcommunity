...
const MainTexts = () => {
    ...
    return (
        <>
            ...
            <div className="p-2 mt-2 c_md:mt-10 flex flex-row w-2/5 c_md:w-1/3 h-auto justify-between items-center">
                <Tippy content="더워드처치 유튜브" key={"youtube"}>
                    <button 
                        ...
                        onClick={() => openPopup("https://www.youtube.com/@thewordchurch522")}>
                            <FaYoutube className="w-[20px] c_md:w-[30px] h-auto text-black dark:text-white"/>
                    </button>
                </Tippy>
