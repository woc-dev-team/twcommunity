...
const MainTexts = () => {
    ...
    return (
        <>
            ...
            <p className="text-black dark:text-white p-2 text-4xl twc_main_text_md:text-5xl twc_main_text_xl:text-6xl font-semibold transition-all duration-500 ease-in-out hover:scale-105">{languagePacks[languageIndex].mainTexts?.title}</p>
