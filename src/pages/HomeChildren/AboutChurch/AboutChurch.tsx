...
import ChurchVision from "./ChurchVision";

const AboutChurch = () => {
    return (
        <div id="twc" className="relative z-20 mt-10 h-screen p-8 c_md:p-20 transition-all duration-500 ease-in-out c_image:grid c_image:grid-cols-10 gap-4">
