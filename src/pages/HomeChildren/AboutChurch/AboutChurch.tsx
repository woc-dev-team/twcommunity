...
const AboutChurch = () => {
    ...
    return (
        <>
            <div id="info" className="h-full w-full p-5 text-6xl text-center transition-all duration-500 ease-in-out">
                ...
                {/* 여기서 세 파트 */}
                <div className="flex flex-col md:flex-row h-full w-full gap-5 mb-20 font-semibold place-self-center">
