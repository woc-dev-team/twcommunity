        ...
        <>
            ...
            <div className="transition-all duration-500 ease-in-out mb-20 w-full h-full c_md:w-1/3">
                ...
                <div className="flex-row pt-10">
                    <button onClick={() => startPopUp(languagePacks[languageIndex].aboutChurch.counsel.nurture.title, "https://docs.google.com/forms/d/e/1FAIpQLSclOc3ENeRSNp3gzyt3Xruvfp3ntuvCjuJIoXKeXr-lSIpAkw/viewform")}>
                        <img src={QRNurture} className="w-2/5 h-auto place-self-center rounded-lg" />
                    </button>
                ...
                <div className="flex-row mt-20 c_md:pt-0">
                    <button onClick={() => startPopUp(languagePacks[languageIndex].aboutChurch.counsel.nurture.title, "https://docs.google.com/forms/d/e/1FAIpQLSfHjzaTOq0CYpptmyrdpmGNFu6oVOV9Qcf-v1p_w6oE7X1z8w/viewform")}>
                        <img src={QRCounseling} className="w-2/5 h-auto place-self-center rounded-lg" />
                    </button>
                    <div className="h-full w-full">
