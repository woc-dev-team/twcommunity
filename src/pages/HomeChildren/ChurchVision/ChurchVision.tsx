...
const ChurchVision = () => {
    ...
    return (
        <div id="vision" className="relative z-20 mt-10 h-screen p-8 c_md:p-20 transition-all duration-500 ease-in-out c_image:grid c_image:grid-cols-10 gap-4">
            {/* {darkMode ? (
                <div className="w-full h-3/5 mt-36 absolute inset-0 bg-[url('./assets/images/twc_dark_mode.png')] bg-no-repeat bg-cover bg-center c_image:bg-none blur-md -z-10"></div>
            ):(
                <div className="w-full h-3/5 mt-36 absolute inset-0 bg-[url('./assets/images/twc_light_mode.png')] bg-no-repeat bg-cover bg-center c_image:bg-none blur-md -z-10"></div>
            )} */}
