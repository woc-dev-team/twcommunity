const VisionTexts = () => { 
    return (
        <div className="w-full c_image:col-span-6 z-30">
            ...
            <p className="dark:text-white text-sm c_sm:text-md c_md:text-lg mt-3 font-thin"><span className="font-normal">The Word Church</span>가 추구하는 방향은 그리스도가 중심인 교회, 차별이 없는 교회, 하나님을 위한 교회, 말씀 위에 세운 교회, 아는 것과 믿는 것이 일치되는 교회, 선포하고 가르치는 교회, 사랑 안에서 참된 것을 말하는 교회, 말씀 안에서 예배하는 교회, 각자의 분량대로 섬기는 교회입니다.</p>
            <p className="dark:text-white text-sm c_sm:text-md c_md:text-lg mt-3 font-thin"><span className="font-normal">The Word Church</span>는 바른 신학을 추구하며, 아는 것과 믿는 것이 하나되어 어깨 너머 배우는 것 이 아닌 말씀과 교리를 배우고, 말씀 안에서 예배하고자 합니다.</p>
            <p className="dark:text-white text-sm c_sm:text-md c_md:text-lg mt-7 font-normal">함께 비전을 가지고 예배하길 소망합니다.</p>
        </div>
    )
}
