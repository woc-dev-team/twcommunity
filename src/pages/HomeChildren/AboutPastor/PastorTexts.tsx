...
const PastorTexts = ({profileImg}: PastorTextsProps) => {
    ...
    return (
        <div className="text-black dark:text-white h-screen c_md:col-span-5">
            ...
            <p className="text-lg c_sm:text-xl c_md:text-3xl mt-14 c_md:mt-20 font-thin">총신대학교 신학대학원</p>
            <p className="text-lg c_sm:text-xl c_md:text-3xl mt-8 font-thin">총신대학교 일반대학원 석사 (Th.M 조직신학)</p>
            <p className="text-lg c_sm:text-xl c_md:text-3xl mt-8 font-thin">총신대학교 일반대학원 박사과정 (Ph.D 조직신학)</p>
        </div>
    )
}
