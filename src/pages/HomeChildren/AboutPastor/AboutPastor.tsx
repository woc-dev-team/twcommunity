...
<div id="pastor" className="relative c_md:grid c_md:grid-cols-10 z-30 h-full p-6 c_md:p-24 c_md:ps-32 text-start transition-all duration-500 ease-in-out">
    {/* 배경 이미지 */}
    <img src={TheWordChurchLogo} alt="Background" className="mb-20 absolute w-3/5 h-auto left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 object-contain blur-sm -z-10" />
