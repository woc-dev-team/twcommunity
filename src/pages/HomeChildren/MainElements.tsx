...
const MainElements = () => {
    ...
    return (
        <div className="h-screen c_image:grid c_image:grid-cols-10 gap-4 text-start transition-all duration-500 ease-in-out">
            <div className="h-full p-8 c_md:ps-20 c_md:pt-20 c_image:col-span-4">
            ...
            <div className="hidden c_image:block relative c_image:col-span-6">
                <img
                    src={TheWordChurchImage}
                    alt="교회 이미지"
                    className="w-full h-screen object-cover"
                />
                <div className="absolute inset-y-0 left-0 w-3/5 bg-gradient-to-r from-white to-transparent" />
