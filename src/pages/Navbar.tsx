import LanguageDrop from "../features/LanguageDrop";
    ...
    return (
        <nav className="bg-white border-gray-200 dark:bg-black">
            ...
            <a href="http://localhost:5173/" className="flex items-center space-x-3 rtl:space-x-reverse">
                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">The Word Church</span>
            </a>
            <LanguageDrop />
